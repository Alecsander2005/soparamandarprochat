...
class Entity(Base):
    ...
    code = models.CharField('Código da Entidade no EM8', max_length=10, default=0)
...
class Enjoyer(Base):
    ...
    image = models.ImageField('Image', upload_to='enjoyers', blank=True, null=True)
    uuid_portal = models.UUIDField('UUID no Portal', editable=True, blank=True, null=True)
...
class Military(Base):
    ...
    uuid_portal = models.UUIDField('UUID no Portal', editable=True, blank=True, null=True)
    image = models.ImageField('Image', upload_to='militaries_pmpb', blank=True, null=True)
